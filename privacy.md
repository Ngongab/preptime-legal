...
- **Study activity** — quizzes you take, answers you submit, flashcards you review, and notes you create.
- **Profile photo** — only if you choose to add one. Photos are picked from your device with your permission.

### Information collected automatically
- **Device and usage data** — device model, OS version, app version, language, crash reports, and anonymised usage events. Collected via Google Firebase (Analytics and Crashlytics).
