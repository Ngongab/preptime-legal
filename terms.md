...
These Terms of Service ("Terms") govern your use of the **Prep Time** mobile application. By installing or using Prep Time you agree to these Terms.

## 1. Eligibility

You must be at least 13 years old to use Prep Time. If you are under 18, you confirm that a parent or guardian has reviewed these Terms on your behalf.
...
- Use the app to cheat in any live, monitored examination.
- Reverse-engineer, scrape, or attempt to extract the full question bank.
- Resell, redistribute, or republish content from the app.
- Use the app to harass, abuse, or harm other users.
- Attempt to bypass paywalls, subscription checks, or device security.

We may suspend or terminate accounts that violate these rules.

## 4. Past papers and educational content

Prep Time references questions and topics from publicly released **ECZ (Examinations Council of Zambia)** and **GCE (General Certificate of Education)** past papers. These materials are used for educational and revision purposes. All trademarks and copyrights remain with their respective owners. If you are a rights holder and have a concern, please email us and we will respond promptly.

## 5. Prep Time Pro subscriptions

Prep Time offers an optional paid subscription, **Prep Time Pro**, with the following plans:

- **Monthly**, **Quarterly**, **Six-Month**, and **Annual** auto-renewing subscriptions.
- A **7-day free trial** may be offered to eligible new subscribers.

**Billing.** All purchases are processed by Google Play or the Apple App Store, not by us directly. Prices are shown in the app before purchase and may vary by region.
...
**How to cancel.** Manage or cancel your subscription in your Google Play account or your Apple ID subscription settings. Uninstalling the app does **not** cancel your subscription.
